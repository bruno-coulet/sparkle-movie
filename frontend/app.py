...
from config import PAGE_CONFIG, API_URL
from utils import (
    fetch_statistics,
    fetch_genres,
...
st.markdown('<div class="section-title">Votre Profil (Utilisateur #' + str(user_id) + ')</div>', unsafe_allow_html=True)
...
if genres_data and genres_data.get('genres'):
    ...
    genres_df = pd.DataFrame([
        {"Genre": g['genre'], "Évaluations": g['n_ratings']}
        for g in top_genres
    ])
